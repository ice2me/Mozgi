...
import LanguageImage from "../../assets/images/language-image.png"
import { APP_ROUTE } from "../../utils/constants"

const HeaderMob = ({countOffset, toggleBurger, setToggleBurger }) => {

	return (
		<div className='header-desktop'>
			<div className='header-desktop_language'>
				<div className='header-desktop_language-container'>
					<img
						src={LanguageImage}
						alt='Language Image'
						className='header-desktop_language-container_image'
					/>
				</div >
				<div className='header-desktop_language-block'>
					<p className='header-desktop_language-block_one'>RU</p >
					<p className='header-desktop_language-block_two'>UA</p >
				</div >
			</div >
			<div className='header-desktop_wrapper'>
				<svg
					width='85'
					height='46'
					viewBox='0 0 85 46'
			...
			<button className='header-desktop_burger' onClick={() => setToggleBurger(!toggleBurger)}></button >
			<ul className={`header-desktop_burger-container ${toggleBurger ? 'active-burg' : ''}`}>
					<li className='header-desktop_burger-item'>
					<a
						href={APP_ROUTE.WHERE}
						className='header-desktop_burger-item_link'
					>
						where?
						</a >
					</li >
